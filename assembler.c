 ...
 *      Author: Sukruth N Bhat
 */
#include <stdlib.h>
#include <stdio.h>
#include <string.h>
#include "file_parser.h"
//#include "hash_table.h" what does it do??
...
// Quick Sort String Comparison Function why??
...
int main (int argc, char *argv[]) {
	...
	if (argc != 3) {
		...
		// Sort the array using qsort for faster search why??
		qsort(instructions, inst_len, sizeof(char *), string_comp);

		// Create a hash table of size 127   why??
